...
const triggerSet: OopsyTriggerSet<Data> = {
  ...
  damageWarn: {
    ...
    'ASS Gladiator Rush of Might Front': '796B', // initial 180 cleave in front
    'ASS Gladiator Rush of Might Back': '796C', // followup 180 cleave behind
  ...
  shareFail: {
    ...
    'ASS Shadowcaster Firesteel Strike': '74B0', // jumps before Blessed Beacon cleaves
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegex: NetRegexes.ability({ id: '74B4' }),
